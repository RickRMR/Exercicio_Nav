...
import com.richard.exercicio_nav.databinding.FragmentScoreBinding

class FragmentScore : Fragment() {
    lateinit var engine : JokenpoEngine
    lateinit var bind: FragmentScoreBinding
    ...
    override fun onCreateView(
        ...
        bind = FragmentScoreBinding.inflate(inflater, container , false)
    ...
    private fun updateResultText(currentPlay : String){
        ...
        resultText.text = when (resultGame){
            com.richard.exercicio_nav.Result.WIN -> "You Win!!"
            com.richard.exercicio_nav.Result.LOSS -> "You Lose!!"
            else -> "Draw"
        }
    }
